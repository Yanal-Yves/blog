...
Un mot sur le vocabulaire. L'anglais *proprietary* se traduit habituellement par « propriétaire » — un terme neutre, qui décrit **qui détient le code**. Richard Stallman et la communauté du logiciel libre francophone lui préfèrent « privateur » : il ne désigne pas un autre type de logiciel, mais le **même** sous un autre angle. Là où « propriétaire » parle de possession, « privateur » nomme l'**effet** sur l'utilisateur — ce type de logiciel **prive l'utilisateur de ses libertés** : celle d'étudier le programme, de le modifier, de le corriger, de le faire vivre quand son éditeur a décidé de le laisser mourir. Ce n'est donc pas une coquetterie, et c'est le mot que j'emploie dans cet article. Avec un logiciel privateur, comme l'explique Stallman, **ce n'est pas l'utilisateur qui contrôle le programme : c'est le programme qui contrôle l'utilisateur**, et c'est l'éditeur qui contrôle le programme. (Voir la [définition du logiciel libre](https://www.gnu.org/philosophy/free-sw.fr.html) et [« Le logiciel libre est encore plus essentiel maintenant »](https://www.gnu.org/philosophy/free-software-even-more-important.fr.html).)

Cet article repose sur des **situations réelles** : pour la plupart, des **murs sur lesquels je me suis personnellement heurté** ; pour le reste, des cas que j'ai vus **frapper mes proches**, ou qui m'ont été **rapportés par d'autres professionnels de mon secteur** — et je le signale au fil du texte. Il montre ensuite ce que le logiciel libre aurait changé, et ouvre une série, en cours d'écriture, sur le logiciel libre et les licences. Je ne raconte pas une théorie. J'ai vérifié les faits et les dates auprès de sources publiques, listées en fin d'article ; quand un souvenir n'a pas pu être confirmé précisément, je le signale.
...
- Windows Phone, absence de mise à niveau d'une génération à l'autre — [TechCrunch : les appareils Windows Mobile 6.5 ne seront pas mis à niveau vers Windows Phone 7](https://techcrunch.com/2010/03/01/windows-mobile-6-5-upgrade-windows-phone-7) · [PCWorld : « Windows Phone 7 Users Can't Upgrade to WP8 »](https://www.pcworld.com/article/465464/windows_phone_7_users_cant_upgrade_to_wp8.html) · [Windows Phone 7, Wikipédia (EN)](https://en.wikipedia.org/wiki/Windows_Phone_7) · [Windows Phone 8, Wikipédia (EN)](https://en.wikipedia.org/wiki/Windows_Phone_8)
