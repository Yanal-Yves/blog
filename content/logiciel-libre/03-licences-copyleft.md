...
Détail révélateur : le **noyau Linux est resté en GPLv2** et n'est jamais passé à la GPLv3. Linus Torvalds a explicitement rejeté la clause anti-tivoïsation, qu'il juge hors du périmètre d'une licence logicielle. Le sujet divise donc jusqu'au cœur du monde libre — au point que je lui consacre [un article à part](../04-torvalds-gplv3/).
